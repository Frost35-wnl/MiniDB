...
//We need const list
 const char *list1[] = {"abc", "edf"};
 const char *list2[] = {"monday", "tuesday", "wednesday", "thursday", "friday", "saturday", "sunday"};

  Row row1 = create_row(list1, 2);
  Row row2 = create_row(list2, 7);
