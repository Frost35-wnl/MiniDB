...
bool test_table_adt() {
  ...
  const char *list[] = {"monday", "tuesday",  "wednesday", "thursday",
  ...
  const char *values4[] = {"0", "1", "2", "3", "4", "5",
                           "6", "7", "8", NULL}; // testing if the values is
                                                 // bigger than fields number
...
bool test_row_adt() {
  ...
  const char *list2[] = {"monday", "tuesday",  "wednesday", "thursday",
                         "friday", "saturday", "sunday",    NULL};
